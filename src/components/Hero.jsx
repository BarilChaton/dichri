...
const Hero = () => {
  return (
    <div name='hero' className='w-screen h-full pt-[200px] pb-[100%] md:pt-[180px] md:pb-[70%] bg-[#f3c2db]'>
      ...
      <div className='flex flex-col'>
        ...
        {/* Picture Container */}
        <div className='flex max-h-[250px] justify-self-auto sm:flex sm:max-h-[500px] sm:justify-center'>
